...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("LoanCalculator loancalculator 1c148a37-66cd-4493-88e1-d4eae54ea626 -484213338968826295".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in com.kirkk.loancalc package as a set of config entries
        return configLoader.fromResource("com/kirkk/loancalc/settings");
    }
